        ...
        <div class="flex shadow-md my-10">
              ...
              return (
                <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                  <div class="flex w-2/5">
                    <div class="w-20">
                      <img class="h-24" src={item.strMealThumb} alt="" />
                    </div>
                    <div class="flex flex-col justify-between ml-4 flex-grow">
                      <span class="font-bold text-sm">{item.strMeal}</span>

                      <span class="text-red-500 text-xs">{item.strCategory}</span>
                      <button onClick={handleRemove(item.idMeal)} class="font-semibold hover:text-red-500 text-gray-500 text-xs">Remove</button>
                    </div>
                  </div>
                  ...
                  <span class="text-center w-1/5 font-semibold text-sm">₹{item.idMeal.slice(2, 4)}.00</span>
                  <span class="text-center w-1/5 font-semibold text-sm">₹{item.idMeal.slice(2, 4)}.00</span>
                </div>
              )
            })}
          ...
          <div id="summary" class="w-1/4 px-8 py-10">
            ...
            <div class="border-t mt-8">
              ...
              <button class="bg-green-500 font-semibold hover:bg-green-600 py-3 text-sm text-white uppercase w-full">Pay Now</button>
            </div>
          </div>
