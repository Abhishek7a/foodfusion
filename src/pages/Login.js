          ...
          <div className="w-72">
              ...
              <form className="mt-4">
                <div className="mb-3">
                  ...
                  <input type="email" placeholder="Enter your email" className="block w-full rounded-md border border-gray-300 focus:border-red-700 focus:outline-none focus:ring-1 focus:ring-red-700 py-1 px-1.5 text-gray-500" />
                </div>

                <div className="mb-3">
                  <label className="mb-2 block text-xs font-semibold">Password</label>
                  <input type="password" placeholder="*****" className="block w-full rounded-md border border-gray-300 focus:border-red-700 focus:outline-none focus:ring-1 focus:ring-red-700 py-1 px-1.5 text-gray-500" />
                </div>
                ...
                <div className="mb-3 flex flex-wrap content-center ">
                  ...
                  <a href="#" className="text-xs font-semibold text-red-700">Forgot password?</a>
                </div>
